    ...
    <section className="px-6 py-16 bg-slate-950 text-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <ul className="max-w-3xl mx-auto list-disc pl-6 text-slate-300 space-y-2">
...
const SkillCard = ({ icon, title, details }) => (
  <div className="bg-slate-900 p-6 rounded-xl shadow-lg border border-slate-800 hover:border-green-400 transition">
